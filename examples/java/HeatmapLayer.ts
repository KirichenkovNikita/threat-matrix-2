...
*    
*    Repositories:
*     - repo: https://github.com/apache/echarts/blob/5.0.0-alpha.1/src/chart/heatmap/HeatmapLayer.ts release version: 5.0.0-alpha.1  asset relative path: src/chart/heatmap/HeatmapLayer.ts
*    
*    Copyrights:
*    
*    Licenses:
