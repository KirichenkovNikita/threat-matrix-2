...
*    
*    Repositories:
*     - repo: https://github.com/spring-projects/spring-boot-data-geode release version: -  asset relative path: /spring-geode/src/main/java/org/springframework/geode/core/util/ObjectUtils.java
...
*     - repo: https://github.com/spring-projects/spring-boot release version: -  asset relative path: /spring-boot-project/spring-boot-devtools/src/main/java/org/springframework/boot/devtools/livereload/Connection.java
...
*     - repo: https://github.com/spring-projects/spring-authorization-server release version: -  asset relative path: /oauth2-authorization-server/src/main/java/org/springframework/security/oauth2/core/OAuth2TokenIntrospection.java
*    
*    Copyrights:
