...
*    
*    Repositories:
*     - repo: https://github.com/aspnet/AspNetWebStack/blob/v3.3.0/src/Common/CollectionExtensions.cs release version: v3.3.0  asset relative path: src/Common/CollectionExtensions.cs
*    
*    Copyrights:
*    
*    Licenses:
