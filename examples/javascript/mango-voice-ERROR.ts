...
*    
*    Repositories:
*     - repo: https://github.com/sillsdev/web-xforge/blob/SF-QAv394/src/SIL.XForge.Scripture/ClientApp/src/xforge-common/ui-common.module.ts release version: SF-QAv394  asset relative path: src/SIL.XForge.Scripture/ClientApp/src/xforge-common/ui-common.module.ts
*    
*    Copyrights:
*    
*    Licenses:
