...
*    
*    Repositories:
*     - https://github.com/spring-projects/spring-boot/blob/v2.4.10/spring-boot-project/spring-boot-devtools/src/main/java/org/springframework/boot/devtools/livereload/Connection.java
*    
*    Copyrights:
