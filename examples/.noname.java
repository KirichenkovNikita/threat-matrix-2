...
*    
*    Repositories:
*     - repo: http://github.com/spring-projects/spring-security release version: 02-04-2025  asset relative path: crypto/src/main/java/org/springframework/security/crypto/codec/Base64.java
...
*     - repo: http://github.com/json-iterator/go release version: 02-04-2025  asset relative path: type_tests/map_key_test.go
*     - repo: http://github.com/KirichenkovNikita/kirichenkov-threatrix release version: 02-04-2025  asset relative path: /.gitattributes
*    
*    Copyrights:
